...
def main():
    ...
    with open(
        "../../Data/enzyme_promiscuity/test_preferred_alternative_random.txt", "r"
    ) as infile:
    ...
    print(
        "The median value of preferred_substrates: %.4f" % median(preferred_substrates)
    )
    print(
        "The median value of alternative_substrates: %.4f"
        % median(alternative_substrates)
    )
    print("The median value of random_substrates: %.4f" % median(random_substrates))
    print(
        "The real value of preferred substrates: %.2f"
        % pow(10, median(preferred_substrates))
    )
    print(
        "The real value of alternative substrates: %.2f"
        % pow(10, median(alternative_substrates))
    )
    print(
        "The real value of random substrates: %.2f" % pow(10, median(random_substrates))
    )
    print(
        "P value between preferred_substrates and alternative_substrates is: %s"
        % p_value_1
    )
    print(
        "P value between preferred_substrates and random_substrates is: %s" % p_value_2
    )
    print(
        "P value between alternative_substrates and random_substrates is: %s"
        % p_value_3
    )
    ...
    ax = sns.boxplot(
        ...
        x="type",
        y="value",
        order=["Random", "Alternative", "Preferred"],
        palette=palette,
        showfliers=False,
        linewidth=0.5,
        width=0.5,
    ...
    plt.ylabel(
        "Predicted $k$$_\mathregular{cat}$ value [log10]",
        fontname="Helvetica",
        fontsize=7,
    )
