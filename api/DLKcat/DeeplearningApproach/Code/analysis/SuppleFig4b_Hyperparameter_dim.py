...
with open(
    "../../Data/output_hyper/MAEs--all--radius2--ngram3--dim5--layer_gnn3--window11--layer_cnn3--layer_output3--lr1e-3--lr_decay0.5--decay_interval10--weight_decay1e-6--iteration50.txt",
    "r",
) as infile1:
...
with open(
    "../../Data/output_hyper/MAEs--all--radius2--ngram3--dim20--layer_gnn3--window11--layer_cnn3--layer_output3--lr1e-3--lr_decay0.5--decay_interval10--weight_decay1e-6--iteration50.txt",
    "r",
) as infile3:
