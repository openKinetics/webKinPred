...
with open(
    "../../Data/five_fold/MAEs--all--radius2--ngram3--dim20--layer_gnn3--window11--layer_cnn3--layer_output3--lr1e-3--lr_decay0.5--decay_interval10--weight_decay1e-6--iteration50_fold_1.txt",
    "r",
) as infile1:
    lines1 = infile1.readlines()[1:]

with open(
    "../../Data/five_fold/MAEs--all--radius2--ngram3--dim20--layer_gnn3--window11--layer_cnn3--layer_output3--lr1e-3--lr_decay0.5--decay_interval10--weight_decay1e-6--iteration50_fold_2.txt",
    "r",
) as infile2:
    lines2 = infile2.readlines()[1:]

with open(
    "../../Data/five_fold/MAEs--all--radius2--ngram3--dim20--layer_gnn3--window11--layer_cnn3--layer_output3--lr1e-3--lr_decay0.5--decay_interval10--weight_decay1e-6--iteration50_fold_3.txt",
    "r",
) as infile3:
    lines3 = infile3.readlines()[1:]

with open(
    "../../Data/five_fold/MAEs--all--radius2--ngram3--dim20--layer_gnn3--window11--layer_cnn3--layer_output3--lr1e-3--lr_decay0.5--decay_interval10--weight_decay1e-6--iteration50_fold_4.txt",
    "r",
) as infile4:
    lines4 = infile4.readlines()[1:]

with open(
    "../../Data/five_fold/MAEs--all--radius2--ngram3--dim20--layer_gnn3--window11--layer_cnn3--layer_output3--lr1e-3--lr_decay0.5--decay_interval10--weight_decay1e-6--iteration50_fold_5.txt",
    "r",
) as infile5:
