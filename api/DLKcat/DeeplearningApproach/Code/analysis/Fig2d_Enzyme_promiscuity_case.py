...
def main():
    ...
    with open(
        "../../Data/enzyme_promiscuity/human_aldo-keto-reductase.tsv", "r"
    ) as infile:
        ...
        for line in lines[1:]:
            ...
            substrate, experimental, predicted = (
                data[1],
                float(data[-2]),
                float(data[-1]),
            )
        ...
        sorted_substrate_experimental = sorted(
            substrate_experimental.items(), key=lambda x: x[1], reverse=True
        )
        print(sorted_substrate_experimental[:10])

        native_substrates_list = [
            substrate_value[0] for substrate_value in sorted_substrate_experimental[:6]
        ]
        underground_substrates_list = [
            substrate_value[0] for substrate_value in sorted_substrate_experimental[-6:]
        ]
    ...
    print(
        "The median value of native_substrates on log10: %.4f"
        % median(native_substrates)
    )
    print(
        "The median value of underground_substrates on log10: %.4f"
        % median(underground_substrates)
    )
    print(
        "The median value of native_substrates: %.2f"
        % math.pow(10, median(native_substrates))
    )
    print(
        "The median value of underground_substrates: %.2f"
        % math.pow(10, median(underground_substrates))
    )
