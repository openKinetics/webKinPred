...
def main():
    ...
    # Results:
    # The data point number is: 9411
    # 0.8652380379175421
    # 0.0
    # R2 is 0.7356302934580942
    # RMSE is 0.7384936170402133
    ...
    ax = plt.scatter(
        x=experimental_values,
        y=predicted_values,
        c=experimental_predicted,
        s=3,
        edgecolor=[],
    )
    ...
    plt.text(-6.7, 6.0, "r = 0.87", fontweight="normal", fontsize=6)
    plt.text(-6.7, 5.0, "P value = 0", fontweight="normal", fontsize=6)
    plt.text(-6.7, 3.9, "N = 9,411", fontweight="normal", fontsize=6)

    plt.text(2, -6, "Wildtype", fontweight="normal", fontsize=6)

    plt.rcParams["font.family"] = "Helvetica"

    plt.xlabel(
        "Experimental $k$$_\mathregular{cat}$ value",
        fontdict={"weight": "normal", "fontname": "Helvetica", "size": 7},
        fontsize=7,
    )
    plt.ylabel(
        "Predicted $k$$_\mathregular{cat}$ value",
        fontdict={"weight": "normal", "fontname": "Helvetica", "size": 7},
        fontsize=7,
    )
    ...
    plt.savefig("../../Results/figures/Fig3a.pdf", dpi=400, bbox_inches="tight")
