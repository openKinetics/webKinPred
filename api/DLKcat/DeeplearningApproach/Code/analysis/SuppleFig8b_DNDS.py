...
def main():
    ...
    all_clades_order = {
        ...
        "Lipomycetaceae": 2,
        "Trigonopsidaceae": 3,
        "Dipodascaceae/Trichomonascaceae": 4,
        "Alloascoideaceae": 5,
        "Sporopachydermia clade": 6,
        "Pichiaceae": 7,
        "CUG-Ala": 8,
        "CUG-Ser1": 9,
        "CUG-Ser2": 10,
        "Phaffomycetaceae": 11,
        "Saccharomycodaceae": 12,
        "Saccharomycetaceae": 13,
    }
    ...
    for clade in all_clades:
        for organism in organisms:
            if species_clades[organism.lower()] == clade:
                ...
                with open(
                    "../prediction/343species_0115/%s_PredictionResults.txt" % organism,
                    "r",
                ) as infile:
