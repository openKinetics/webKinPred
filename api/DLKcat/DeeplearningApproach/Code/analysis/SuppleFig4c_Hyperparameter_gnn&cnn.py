...
with open(
    "../../Data/output_hyper/MAEs--all--radius2--ngram3--dim10--layer_gnn2--window11--layer_cnn2--layer_output2--lr1e-3--lr_decay0.5--decay_interval10--weight_decay1e-6--iteration50.txt",
    "r",
) as infile1:
...
with open(
    "../../Data/output_hyper/MAEs--all--radius2--ngram3--dim10--layer_gnn4--window11--layer_cnn4--layer_output4--lr1e-3--lr_decay0.5--decay_interval10--weight_decay1e-6--iteration50.txt",
    "r",
) as infile3:
