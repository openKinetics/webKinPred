...
with open(
    "../../Data/output_hyper/MAEs--all--radius0--ngram1--dim10--layer_gnn3--window11--layer_cnn3--layer_output3--lr1e-3--lr_decay0.5--decay_interval10--weight_decay1e-6--iteration50.txt",
    "r",
) as infile1:
    lines1 = infile1.readlines()[1:]

with open(
    "../../Data/output_hyper/MAEs--all--radius1--ngram2--dim10--layer_gnn3--window11--layer_cnn3--layer_output3--lr1e-3--lr_decay0.5--decay_interval10--weight_decay1e-6--iteration50.txt",
    "r",
) as infile2:
    lines2 = infile2.readlines()[1:]

with open(
    "../../Data/output_hyper/MAEs--all--radius2--ngram3--dim10--layer_gnn3--window11--layer_cnn3--layer_output3--lr1e-3--lr_decay0.5--decay_interval10--weight_decay1e-6--iteration50.txt",
    "r",
) as infile3:
