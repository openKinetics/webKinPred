...
with open(
    "../../Data/database/Kcat_sabio_4_unisubstrate.tsv", "r", encoding="utf-8"
) as file:
...
for line in lines:
    ...
    Kcat_data.append(
        [Type, ECNumber, Substrate, EnzymeType, PubMedID, Organism, UniprotID]
    )
...
print(
    len(new_lines)
)  # 21627 included all elements, 18296 included all except for Kcat value and unit
...
print(
    len(clean_Kcat)
)  # 18243 after unifing the Kcat value unit to 's^(-1)', in which 16825 has a specific Unipro ID
