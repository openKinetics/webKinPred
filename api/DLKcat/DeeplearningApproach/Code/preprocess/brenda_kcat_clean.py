...
for line in lines:
    ...
    Kcat_data_include_value.append(
        [Type, ECNumber, Substrate, EnzymeType, Organism, Value, Unit]
    )
...
print(
    len(new_lines)
)  # 67566 included all elements, 52390 included all except for Kcat value and unit, 32305 if further not include enzymeType
