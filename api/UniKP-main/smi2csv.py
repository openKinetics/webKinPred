...
def main():
    ...
    parser.add_argument(
        "--in_path", "-i", type=str, default="data/GDB/GDB08.smi", help="input file"
    )
    parser.add_argument(
        "--out_path_1",
        "-o1",
        type=str,
        default="data/gdb08_bert_train.csv",
    ...
    parser.add_argument(
        ...
        "-o2",
        type=str,
        default="data/gdb08_bert_test.csv",
        help="output file (test)",
    )
    parser.add_argument(
        "--max", "-m", type=int, default=2e6, help="Maximum number of molecules"
    )
